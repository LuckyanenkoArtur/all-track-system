...
import { useUserProfile, type UserBio } from "../../context/UserProfileContext";
import { countries, getCountryByCode, timezones } from "../../data/countries";
    ...
    <div className="user-page__tab-content user-page__tab-content--bio">
      ...
      <section className="user-page__section">
        <div className="user-page__section-header">
          <h3 className="user-page__section-title">{t.userPage.bio.personalInfo}</h3>
          <p className="user-page__section-desc">{t.userPage.bio.personalInfoDesc}</p>
        </div>
        <div className="user-page__grid">
          <div className="user-page__field">
            <label className="user-page__label">{t.userPage.bio.firstName}</label>
            <input
          ...
          <div className="user-page__field">
            <label className="user-page__label">{t.userPage.bio.lastName}</label>
            <input
              className="user-page__input"
              value={form.lastName}
          ...
          <div className="user-page__field">
            <label className="user-page__label">{t.userPage.bio.timezone}</label>
            <select
              className="user-page__select"
              value={form.timezone}
      ...
      <section className="user-page__section">
        <div className="user-page__section-header">
          <h3 className="user-page__section-title">{t.userPage.bio.contactInfo}</h3>
          <p className="user-page__section-desc">{t.userPage.bio.contactInfoDesc}</p>
        </div>
        <div className="user-page__grid">
          ...
          <div className="user-page__field">
            <label className="user-page__label">{t.userPage.bio.username}</label>
            <input className="user-page__input user-page__input--readonly" value={form.username} readOnly />
            <span className="user-page__hint">{t.userPage.bio.usernameHint}</span>
          </div>
        </div>
      </section>
      ...
      <section className="user-page__section">
        <div className="user-page__section-header">
          <h3 className="user-page__section-title">{t.userPage.bio.accountInfo}</h3>
          <p className="user-page__section-desc">{t.userPage.bio.accountInfoDesc}</p>
        </div>
        <div className="user-page__grid">
          <div className="user-page__field">
            <label className="user-page__label">{t.userPage.bio.role}</label>
            <input className="user-page__input user-page__input--readonly" value={form.role} readOnly />
          </div>
          <div className="user-page__field">
            <label className="user-page__label">{t.userPage.bio.email}</label>
            <input className="user-page__input user-page__input--readonly" value={form.email} readOnly />
          </div>
        </div>
        <button
          type="button"
      ...
      {/* Save bar */}
      <div className={`user-page__save-bar${isDirty ? " user-page__save-bar--visible" : ""}`}>
        <button
          type="button"
